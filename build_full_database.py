...
obgyn_codes = {
    "56420": ("Incision and drainage of Bartholin's gland abscess", 3.25, 0),
    "56440": ("Marsupialization of Bartholin's gland cyst", 4.85, 10),
    "56620": ("Vulvectomy, simple; partial", 8.85, 90),
    "56630": ("Vulvectomy, radical, partial", 16.85, 90),
    "56637": ("Vulvectomy, radical, complete, with unilateral or bilateral inguinofemoral lymphadenectomy", 25.85, 90),
    "57240": ("Anterior colporrhaphy, repair of cystocele with or without repair of urethrocele", 12.25, 90),
    "57260": ("Combined anterior/posterior colporrhaphy", 9.84, 90),
    "57288": ("Sling operation for stress incontinence", 10.22, 90),
    "57425": ("Laparoscopy, surgical, colpopexy", 17.85, 90),
    "57520": ("Conization of cervix with LEEP", 3.72, 90),
    "57522": ("Conization of cervix, loop electrode excision", 5.15, 0),
    "57700": ("Cerclage of uterine cervix, nonobstetrical", 5.35, 10),
    "58100": ("Endometrial biopsy", 1.53, 0),
    "58120": ("Dilation and curettage, diagnostic/therapeutic", 4.11, 0),
    "58140": ("Myomectomy, excision of fibroid tumor(s), 1 to 4 intramural myomas", 16.72, 90),
    ...
    "58240": ("Pelvic exenteration for gynecologic malignancy", 52.85, 90),
    ...
    "58545": ("Laparoscopy, surgical, myomectomy, excision; 1 to 4 intramural myomas", 18.64, 90),
    "58548": ("Laparoscopy, surgical, with radical hysterectomy", 28.85, 90),
    ...
    "58605": ("Ligation or transection of fallopian tube(s), postpartum", 6.85, 90),
    ...
    "58952": ("Bilateral salpingo-oophorectomy with omentectomy, total abdominal hysterectomy for malignancy", 28.85, 90),
    "58956": ("Bilateral salpingo-oophorectomy with total omentectomy for malignancy", 22.85, 90),
    "59000": ("Amniocentesis, diagnostic", 1.52, 0),
    "59012": ("Cordocentesis/fetal blood sampling", 3.09, 0),
    "59150": ("Laparoscopic treatment of ectopic pregnancy; without salpingectomy and/or oophorectomy", 9.25, 90),
    "59151": ("Laparoscopic treatment of ectopic pregnancy; with salpingectomy and/or oophorectomy", 11.05, 90),
    "59325": ("Cerclage of cervix, during pregnancy; abdominal", 12.85, 90),
...
for code, (desc, wrvu, gp) in obgyn_codes.items():
    tier = 3 if gp == 0 else 2
    if code not in cpt_database:
        add_code(code, desc, "Surgery", "reproductive_system", "obgyn",
                 wrvu, gp, bilateral=(code in {"57240", "58700", "58940"}),
                 assistant=(gp != 0), cosurgeon=(gp != 0), tier=tier, family='obgyn')
