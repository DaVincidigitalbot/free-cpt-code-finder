...
Date: 2026-06-22
Branch: deploy/iatrogenic-splenectomy-202606222215
Base: origin/main
Status: Scoped deployment package.
...
- Explicit iatrogenic splenic injury context: CPT 38100/38101 remains visible as selected/performed, but payable wRVU and payable reimbursement are set to 0.00 with a Separate Procedure warning card.
- Unknown splenic context with a related abdominal parent: no automatic suppression. Case Builder shows a review-required Separate Procedure card and keeps the splenectomy payable.
...
- Warning card summary uses “not separately payable” for surgeon-facing clarity.
...
- Confirm warning framework remains live.
- Confirm 44005 + 49000 still validates at selected 30.23 wRVU and payable 18.00 wRVU.
- Confirm 38100/38101 suppression requires explicit iatrogenic splenic injury context.
