...
const reportTools = [
  ...
  { type: 'function', name: 'classify_issue_type', description: 'Classify report into cpt_error, wrvu_error, modifier_bug, missing_code, search_problem, category_placement, case_builder_issue, or other.', parameters: { type: 'object', additionalProperties: false, properties: { description: { type: 'string' }, reportedType: { type: ['string', 'null'] } }, required: ['description', 'reportedType'] } },
