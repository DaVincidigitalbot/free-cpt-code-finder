...
const artifactDir = path.join(repoRoot, 'qa_artifacts', 'iatrogenic_splenectomy_2026_06_22');
...
async function main() {
  ...
  for (const testCase of cases) {
    ...
    const warningVisible = result.warnings.join(' ').includes('separate-procedure splenectomy code');
