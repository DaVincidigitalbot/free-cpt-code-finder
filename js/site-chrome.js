(function () {
  ...
  const homeHref = root || "/";
  const header = `<header class="hdr"><div class="hdr-top"><div><a class="logo" href="${homeHref}" aria-label="Free CPT Code Finder home"><svg class="mk" viewBox="0 0 32 32" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" aria-hidden="true"><path d="M6 6l20 20M11 6h15v15"/><circle cx="8" cy="8" r="2.5"/></svg><div><div class="title">Free CPT Code Finder</div><div class="sub">CPT lookup · wRVUs · modifiers · billing guides</div></div></a></div><div class="hdr-right"><button class="site-menu-btn" type="button" aria-expanded="false" aria-controls="site-mobile-nav">Menu</button><nav class="topnav" aria-label="Primary">${navHtml}${themeToggle}</nav><div class="meta"><span>CMS 2026</span><span class="sep"></span><span>CF 32.3465</span><span class="sep"></span><span class="live">live</span></div></div></div><div id="site-mobile-nav" class="site-mobile-nav"><nav class="topnav" aria-label="Mobile primary">${navHtml}${themeToggle}</nav></div></header>`;
  const footer = `<footer class="site-footer"><div class="site-footer-inner"><div class="site-footer-brand">FreeCPTCodeFinder.com</div><p class="site-footer-copy">FreeCPTCodeFinder.com is an independent educational reference for CPT coding, RVUs, reimbursement, and documentation. Educational information only. Always verify coding, coverage, reimbursement, and compliance decisions with current AMA, CMS, payer, and regulatory guidance.</p><nav class="site-footer-nav" aria-label="Footer"><a href="${homeHref}">Home</a><a href="${root}about.html">About</a><a href="${root}contact.html">Contact</a><a href="${root}privacy.html">Privacy Policy</a><a href="${root}terms.html">Terms of Use</a><a href="${root}legal.html">Legal / CPT Notice</a><a href="${root}editorial-policy.html">Editorial Policy</a><a href="${root}sitemap.xml">Sitemap</a><a href="${root}blog/">Blog / Guides</a><a href="${root}codes/">CPT Code Search</a><a href="${root}cpt-code-for/">CPT Code For</a></nav></div></footer>`;
