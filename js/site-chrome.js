(function () {
  ...
  const footer = `<footer class="site-footer"><div class="site-footer-inner"><div class="site-footer-brand">FreeCPTCodeFinder.com</div><p class="site-footer-copy">FreeCPTCodeFinder.com is an independent educational reference for CPT coding, RVUs, reimbursement, and documentation. Educational information only. Always verify coding, coverage, reimbursement, and compliance decisions with current AMA, CMS, payer, and regulatory guidance.</p><nav class="site-footer-nav" aria-label="Footer"><a href="${homeHref}">Home</a><a href="${root}about.html">About</a><a href="${root}contact.html">Contact</a><a href="${root}privacy.html">Privacy Policy</a><a href="${root}terms.html">Terms of Use</a><a href="${root}legal.html">Legal / CPT Notice</a><a href="${root}editorial-policy.html">Editorial Policy</a><a href="${root}sitemap.xml">Sitemap</a><a href="${root}blog/">Blog / Guides</a><a href="${root}codes/">CPT Code Search</a></nav></div></footer>`;
