(function () {
  ...
  function renderLanding() {
    ...
    const featured = ["transversus-abdominis-release", "parathyroidectomy", "ventral-hernia-repair", "exploratory-laparotomy"].map((slug) => procedures.find((p) => p.slug === slug)).filter(Boolean);
